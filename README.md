...
*Note*: This Plugin currently supports ElasticSearch 5.3.x up to 6.8.x. If you're looking for ElasticSearch Plugin for newer versions check SyliusElasticSearchPlugin in version `2.x`.
