...
Encore
    ...
    .addEntry(`bitbag-${pluginName}-shop`, path.resolve(__dirname, `./src/assets/shop/entry.js`))
    .addEntry(`bitbag-${pluginName}-admin`, path.resolve(__dirname, `./src/assets/admin/entry.js`))
    .cleanupOutputBeforeBuild()
    .disableSingleRuntimeChunk()
    .enableSassLoader();
